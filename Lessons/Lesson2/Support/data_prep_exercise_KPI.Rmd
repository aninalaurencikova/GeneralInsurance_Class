...
dt_KPI_raw <- read.csv("C:/Users/laure/Desktop/Anina_github/GeneralInsurance_Class/Data/lesson2_KPI.csv")
```
...
```{r}
data <- data %>% mutate(Losses = if_else(Losses > 0, Losses, 0), Expenses = if_else(Expenses > 0, Expenses, 0), Premium = if_else(Premium > 0, Premium, 0))
```
